 ...
 * [flip.yml](flip.yml)
     * Determines how your purl.obolibrary.org/obo/flip/ redirects will be handled
     ...
     * Paste in the contents of [flip.yml](flip.yml)
 ...
 * [flip.md](flip.md)
     ...
     * Paste in the contents of [flip.md](flip.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
